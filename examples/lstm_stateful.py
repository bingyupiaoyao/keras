...
plot_model(model_stateful, to_file='../output/examples/lstm_stateful_model_stateful.png', show_shapes=True, show_layer_names=True)
...
plot_model(model_stateless, to_file='../output/examples/lstm_stateful_model_stateless.png', show_shapes=True, show_layer_names=True)
